...
const Pagination = ({ currentPage, totalPages, setPage }) => {
  ...
  const handleNext = () => {
    // prevents from going past the last page
    if (currentPage !== totalPages) {
      setPage((prevPage) => prevPage + 1);
    }
  };

  if (totalPages === 0) return null; // don't show the component if the total number of pages is 0
